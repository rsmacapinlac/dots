...
#
# Updates Homebrew packages/casks, dotfiles via rcup, npm globals, mise tools,
...
# Ensure the AI desktop apps are present. Version upgrades are
...
update_ai_desktop_apps() {
    log_info "Ensuring AI desktop apps..."
