...
- `accounts/` - Individual account configurations
  - `macapinlac` - user@example.com (Google Workspace)
  - `boogienet` - user@example.net (OpenSRS)
  - `gmail` - user@gmail.example
...
- **Email address** - Current account email address (e.g., user@example.com)
